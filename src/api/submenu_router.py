...
async def get_submenu_by_id(
    ...
    return await submenu_service.get_submenu_by_id(
        target_menu_id, target_submenu_id, session
    )
...
async def add_submenu(
    ...
    """
    return await submenu_service.add_submenu(target_menu_id, new_submenu, session)
...
async def update_submenu(
    ...
    return await submenu_service.update_submenu(
        target_menu_id, target_submenu_id, new_submenu, session
    )
